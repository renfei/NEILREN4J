...
public class GoogleAuthenticator {
    ...
    private int window_size = 8; // default 3 - max 17 (from google docs)最多可偏移的时间
     ...
     *
     * @param codes       TOTP
     * @param savedSecret 数据库中保存的获取SecretKey
     * @return
     */
    ...
    public String generateSecretKey() {
        ...
        try {
            ...
            sr.setSeed(Base64.decodeBase64(neilren4jConfig.getGoogletotpseed()));
    ...
    public String getQRBarcodeURL(String user, String secret) {
        ...
        return String.format(format, user, secret, neilren4jConfig.getGoogletotpissuer());
    }
