...
public class TLogAccess {
    ...
    public String getBrowserManufacture() {
        return browserManufacture;
    }

    public void setBrowserManufacture(String browserManufacture) {
        this.browserManufacture = browserManufacture;
    }
    ...
    public void setBrowserMinorVersion(String browserMinorVersion) {
